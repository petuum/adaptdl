...
@pytest.mark.parametrize("num_replicas, grad_acc_steps",
                         [(1, 1), (2, 1), (3, 1), (4, 1),
                          (1, 2), (1, 4), (2, 2), (4, 2)])
@elastic_multiprocessing
def test_profile(num_replicas, grad_acc_steps):
    ...
    if num_restarts() == 0:
        ...
        profile_step_start(1, grad_acc_steps)
        profile_sync_time(1.0)
        # Profile local_bsz=2 and commit.
        profile_step_start(2, grad_acc_steps)
        profile_sync_time(1.0)
